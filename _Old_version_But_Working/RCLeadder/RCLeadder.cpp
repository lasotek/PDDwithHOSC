...
int _tmain(int argc, _TCHAR* argv[])
{
	try
	{
		...
		if (Manager.AddResistor(hCircuit, "R", "I", "2", 1e3, false) < 0) //Resistor definition. false - not as a conductance. Initial value in case of some numerical computation
			PERFORM_ERROR;
		if (Manager.AddResistor(hCircuit, "R", "2", "3", 1e3, false) < 0) //Resistor definition. false - not as a conductance. Initial value in case of some numerical computation
			PERFORM_ERROR;
		if (Manager.AddResistor(hCircuit, "R", "3", "4", 1e3, false) < 0) //Resistor definition. false - not as a conductance. Initial value in case of some numerical computation
			PERFORM_ERROR;
		if (Manager.AddResistor(hCircuit, "R", "4", "O", 1e3, false) < 0) //Resistor definition. false - not as a conductance. Initial value in case of some numerical computation
			PERFORM_ERROR;
		if (Manager.AddCapacitor(hCircuit, "C", "2", "0", 1e-9) < 0)
			PERFORM_ERROR;
		if (Manager.AddCapacitor(hCircuit, "C", "3", "0", 1e-9) < 0)
			PERFORM_ERROR;
		if (Manager.AddCapacitor(hCircuit, "C", "4", "0", 1e-9) < 0)
			PERFORM_ERROR;
		if (Manager.AddCapacitor(hCircuit, "C", "O", "0", 1e-9) < 0)
			PERFORM_ERROR;
