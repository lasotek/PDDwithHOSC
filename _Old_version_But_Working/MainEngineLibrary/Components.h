...
public:
	...
	virtual unsigned GetNoOfPorts() const=0;
	...
	virtual unsigned MaxDescRank()=0;
	...
	virtual size_t GetHash(size_t Core=HASH_CORE) const=0;
...
public:
	...
	virtual unsigned GetNoOfPorts() const override {return 2;}
	virtual const string& GetParameterName() const override {return m_Name;}
	virtual size_t GetHash(size_t Core=HASH_CORE) const override;
	virtual const NumericType& GetParameterValue() const override {return m_Value;}
