...
void KirchhoffInexTesting10()
{
    ...
    std::cout << "______________KirchhoffInexTesting10_________________\n";

    auto main1_claster = HOSC::new_cluster({20, 18, 13},true);
    ...
    auto cluster1 = HOSC::new_cluster({13, 18, 19},true);
    ...
    auto main2_claster = HOSC::new_cluster({6, 12},true);
    auto cluster2 = HOSC::new_cluster({7, 12},true);
    ...
    auto cluster3 = HOSC::new_cluster({5, 6},true);
    ...
    auto main_global_cluster = HOSC::new_cluster({},true);
...
#endif
    auto end = std::chrono::steady_clock::now();
    std::cout << "Multilevel multi-thread\n";
