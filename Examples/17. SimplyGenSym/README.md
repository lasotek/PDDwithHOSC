# General FDCFOA Sallen-Key Filter Analysis – A Symmetrical Case
...
![circuit](FDCFOA_BlackBox_K_u1.svg)
![circuit](FDCFOA_BlackBox_K_u2.svg)
![circuit](FDCFOA_BlackBox_K_uc.svg)

As result of simulation we have

![K_{u1}={{N_{K_{U1}}}\over{D_{K_{U1}}}}](https://render.githubusercontent.com/render/math?math=K_%7Bu1%7D%3D%7B%7BN_%7BK_%7BU1%7D%7D%7D%5Cover%7BD_%7BK_%7BU1%7D%7D%7D%7D)
<!-- $K_{u1}={{N_{K_{U1}}}\over{D_{K_{U1}}}}$ -->
where

![N_{K_{U1}}=S0+S1](https://render.githubusercontent.com/render/math?math=N_%7BK_%7BU1%7D%7D%3DS0%2BS1)

<!-- $N_{K_{U1}}=S0+S1$ -->

and

![$D_{K_{U1}}=S2\cdot\left(s^2\cdot R1\cdot C1\cdot C2\cdot R2+s\cdot\left((C1+C2)\cdot R1+C2\cdot R2\right)+1\right)-(S0+S1)\cdot s\cdot R1\cdot C1](https://render.githubusercontent.com/render/math?math=%24D_%7BK_%7BU1%7D%7D%3DS2%5Ccdot%5Cleft(s%5E2%5Ccdot%20R1%5Ccdot%20C1%5Ccdot%20C2%5Ccdot%20R2%2Bs%5Ccdot%5Cleft((C1%2BC2)%5Ccdot%20R1%2BC2%5Ccdot%20R2%5Cright)%2B1%5Cright)-(S0%2BS1)%5Ccdot%20s%5Ccdot%20R1%5Ccdot%20C1)

<!-- $D_{K_{U1}}=S2\cdot\left(s^2\cdot R1\cdot C1\cdot C2\cdot R2+s\cdot\left((C1+C2)\cdot R1+C2\cdot R2\right)+1\right)-(S0+S1)\cdot s\cdot R1\cdot C1$ -->

![K_{u2}={{N_{K_{U2}}}\over{D_{K_{U2}}}}](https://render.githubusercontent.com/render/math?math=K_%7Bu2%7D%3D%7B%7BN_%7BK_%7BU2%7D%7D%7D%5Cover%7BD_%7BK_%7BU2%7D%7D%7D%7D)

<!-- $K_{u2}={{N_{K_{U2}}}\over{D_{K_{U2}}}}$ -->

![N_{K_{U2}}=(S0+S1)\cdot(s\cdot R1\cdot C1+1)](https://render.githubusercontent.com/render/math?math=N_%7BK_%7BU2%7D%7D%3D(S0%2BS1)%5Ccdot(s%5Ccdot%20R1%5Ccdot%20C1%2B1))
<!-- $N_{K_{U2}}=(S0+S1)\cdot(s\cdot R1\cdot C1+1)$ -->

![D_{K_{U2}}=S2\cdot\left(s^3\cdot R1\cdot R1\cdot C1\cdot C1\cdot C2\cdot R2+s^2\cdot \left((C1+C2)\cdot R1+2\cdot C2\cdot R2\right)\cdot R1\cdot C1+s\cdot \left((2\cdot C1+C2)\cdot R1+C2\cdot R2\right)+1\right)-(S0+S1)\cdot s\cdot R1\cdot C1\cdot \left(s\cdot R1\cdot C1+1\right)](https://render.githubusercontent.com/render/math?math=D_%7BK_%7BU2%7D%7D%3DS2%5Ccdot%5Cleft(s%5E3%5Ccdot%20R1%5Ccdot%20R1%5Ccdot%20C1%5Ccdot%20C1%5Ccdot%20C2%5Ccdot%20R2%2Bs%5E2%5Ccdot%20%5Cleft((C1%2BC2)%5Ccdot%20R1%2B2%5Ccdot%20C2%5Ccdot%20R2%5Cright)%5Ccdot%20R1%5Ccdot%20C1%2Bs%5Ccdot%20%5Cleft((2%5Ccdot%20C1%2BC2)%5Ccdot%20R1%2BC2%5Ccdot%20R2%5Cright)%2B1%5Cright)-(S0%2BS1)%5Ccdot%20s%5Ccdot%20R1%5Ccdot%20C1%5Ccdot%20%5Cleft(s%5Ccdot%20R1%5Ccdot%20C1%2B1%5Cright))
<!-- $D_{K_{U2}}=S2\cdot\left(s^3\cdot R1\cdot R1\cdot C1\cdot C1\cdot C2\cdot R2+s^2\cdot \left((C1+C2)\cdot R1+2\cdot C2\cdot R2\right)\cdot R1\cdot C1+s\cdot \left((2\cdot C1+C2)\cdot R1+C2\cdot R2\right)+1\right)-(S0+S1)\cdot s\cdot R1\cdot C1\cdot \left(s\cdot R1\cdot C1+1\right)$ -->

![K_{u_{com}}=0](https://render.githubusercontent.com/render/math?math=K_%7Bu_%7Bcom%7D%7D%3D0)
<!-- $K_{u_{com}}=0$ -->

We can easily see that 

![D_{K_{U2}}=D_{K_{U1}}\cdot \left(s\cdot R1\cdot C1+1\right)](https://render.githubusercontent.com/render/math?math=D_%7BK_%7BU2%7D%7D%3DD_%7BK_%7BU1%7D%7D%5Ccdot%20%5Cleft(s%5Ccdot%20R1%5Ccdot%20C1%2B1%5Cright))
<!-- $D_{K_{U2}}=D_{K_{U1}}\cdot \left(s\cdot R1\cdot C1+1\right)$ -->
