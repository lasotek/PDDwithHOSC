...
void FullHOSCTests()
{
    ...
    int sgn_f1 = 1;
    std::tie(sgn_f1, hf1) = unique_coll.sgn_insert_unique(hf1);
    ...
    int sgn_f2 = 1;
    std::tie(sgn_f2, hf2) = unique_coll.sgn_insert_unique(hf2);
    ...
    int sgn_f12 = 1;
    std::tie(sgn_f12, hf12) = unique_coll.sgn_insert_unique(hf12);
    ...
    int sgn_f3 = 1;
    std::tie(sgn_f3, hf3) = unique_coll.sgn_insert_unique(hf3);
    ...
    int sgn_f123 = 1;
    std::tie(sgn_f123, hf123) = unique_coll.sgn_insert_unique(hf123);
