...
namespace HOSC
{
    ...
    /**
     * @brief Helper that note if the node has already been removed for rows and columns simultaneously
     * 
     */
    ...
    public:
         ...
         * 
         * @param node Node
         * @return true if node is one of the node to be removed (does not metter if it was already removed)
        ...
        /**
         * @brief Checking if all nodes to be removed really was removed
         * 
         * @return true Each node was removed
         * @return false Some nodes should be but they was not removed
         */
        bool is_complete() const;
    };

    /**
     * @brief Helper that note if the node has already been 
     * 
     */
    ...
    public:
        ...
        bool touch(int n);
        /**
         * @brief Check id all nodes to be removed are removed
         * 
         * @return true if so
    ...
    public:
        ...
        ~NodeTrans() {}
        /**
         * @brief Translate any random node number to consecutive
         * 
         * @param N Random node
        ...
        int extN2inN(int N);
        /**
         * @brief Translate consecutive node number to its original
         * 
         * @param N consecutive number
